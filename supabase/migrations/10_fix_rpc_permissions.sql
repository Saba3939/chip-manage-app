...
-- RPC Functionの権限修正
-- =========================================
-- SECURITY DEFINERで実行されるRPC FunctionがRLSをバイパスできるようにする

-- transfer_chips関数を再作成（SET LOCAL付き）
...
SET search_path = public -- セキュリティのためスキーマを固定
AS $$
DECLARE
...
-- join_session関数を再作成（SET LOCAL付き）
...
-- 関数の実行権限を設定
-- =========================================
-- 認証済みユーザーがRPC Functionを実行できるようにする

GRANT EXECUTE ON FUNCTION transfer_chips TO authenticated;
